...
listen:
  -
    ...
    dhfile: "/var/lib/ejabberd/ssl/dh.dhpem"
    {%- endif %}
...
###   ================
certfiles:
  - "/var/lib/ejabberd/ssl/host.pem"
{%- for xmpp_domain in env['XMPP_DOMAIN'].split() %}
  - "/var/lib/ejabberd/ssl/{{ xmpp_domain }}.pem"
{%- endfor %}
...
{%- if env.get('EJABBERD_DHPARAM', false) == "true" %}
s2s_dhfile: "/var/lib/ejabberd/ssl/dh.dhpem"
{%- endif %}
{% endif %}
